            ...
            <v-card class="card">
              ...
              <v-card-text>
                <v-list-item>
                  ...
                  <v-list-content>{{
                    getMaxIntrRate2(depositProduct.depositoptions_set)
                  }}</v-list-content>
                </v-list-item>
                <v-list-item>
                  <v-list-content>기본 금리 : </v-list-content>
                  <v-list-content>{{
                    getMaxIntrRate(depositProduct.depositoptions_set)
                  }}</v-list-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-content>가입 대상 : </v-list-item-content>
                  <v-list-item-content>{{
                    depositProduct.join_member
                  }}</v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-content>가입 기간 : </v-list-item-content>
                  <v-list-item-content>{{
                    getSavetrmText(depositProduct.depositoptions_set)
                  }}</v-list-item-content>
                </v-list-item>
              </v-card-text>
            </v-card>
            ...
            <v-card class="card">
              ...
              <v-card-text>
                <v-list-item>
                  ...
                  <v-list-content>{{
                    getMaxIntrRate2(savingProduct.savingoptions_set)
                  }}</v-list-content>
                </v-list-item>
                <v-list-item>
                  <v-list-content>기본 금리 : </v-list-content>
                  <v-list-content>{{
                    getMaxIntrRate(savingProduct.savingoptions_set)
                  }}</v-list-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-content>가입 대상 : </v-list-item-content>
                  <v-list-item-content>{{
                    savingProduct.join_member
                  }}</v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-content>가입 기간 : </v-list-item-content>
                  <v-list-item-content>{{
                    getSavetrmText(savingProduct.savingoptions_set)
                  }}</v-list-item-content>
                </v-list-item>
              </v-card-text>
            </v-card>
...
const getMaxIntrRate2 = (arr) => {
  ...
  forchart.value = [
    ...forchart.value,
    { name: arr.fin_prdt_nm, rate: maxRate },
  ];
...
const viewproduct = () => {
  ...
  savingProducts.value = likedsavingProducts
    .sort((a, b) => {
      const getMaxIntrRate = (arr) => {
